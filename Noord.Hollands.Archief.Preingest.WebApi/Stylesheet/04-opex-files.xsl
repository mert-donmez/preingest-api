<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:x="http://www.openpreservationexchange.org/opex/v1.0" exclude-result-prefixes="x">
